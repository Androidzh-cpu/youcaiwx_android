...
import com.ucfo.youcai.view.user.activity.PersonnelSettingActivity;
import com.ucfo.youcai.view.user.activity.SettingActivity;
import com.ucfo.youcai.view.user.activity.WatchTheRecordActivity;
