...
/**
 * Author: AND
 * Time: 2019-7-25.  上午 11:22
 * Package: com.ucfo.youcai.widget.customview
 * FileName: LearnPlanDetailProgressBar
 */
public class LearnPlanDetailProgressBar extends View {
    ...
    public LearnPlanDetailProgressBar(Context context) {
        super(context);
    }

    public LearnPlanDetailProgressBar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
        initPaint();
    }
     ...
     * @return
     */
    public LearnPlanDetailProgressBar setProgressWithAnimation(float progress) {
        mProgress = progress;
        initAnimation();
        return this;
    }
     ...
     * @return
     */
    public LearnPlanDetailProgressBar setCurrentProgress(float progress) {
        mProgress = progress;
     ...
     * @return
     */
    public LearnPlanDetailProgressBar setProgressListener(ProgressListener listener) {
        progressListener = listener;
        return this;
    }

    public LearnPlanDetailProgressBar setTipsText(String progress) {
        this.textString = getResources().getString(R.string.progressbarIndetior, String.valueOf(progress));
        return this;
    }
