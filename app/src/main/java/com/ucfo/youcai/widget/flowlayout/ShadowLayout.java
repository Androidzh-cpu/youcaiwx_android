package com.ucfo.youcai.widget.flowlayout;
...
/**
 * Author:AND
 * Time: 2019-3-6.  上午 11:24
 * Email:2911743255@qq.com
 * ClassName: ShadowLayout
 * Package: com.ucfo.youcai.utils.flowlayout
 * Description:
 * Detail:
 */
public class ShadowLayout extends FrameLayout {
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            mCornerRadius = attr.getDimension(R.styleable.ShadowLayout_sl_cornerRadius, 4);
            mShadowRadius = attr.getDimension(R.styleable.ShadowLayout_sl_shadowRadius, 4);
