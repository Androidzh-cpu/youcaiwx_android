...
/**
 * Author:29117
 * Time: 2019-4-28.  下午 3:45
 * Email:2911743255@qq.com
 * ClassName: CricleFrameLayout
 * Description:TODO  裁剪内容的圆角布局
 */
public class CricleFrameLayout extends FrameLayout {
    ...
    public CricleFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CricleFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        if (attrs != null) {
            TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.CricleFrameLayout);
            float radius = ta.getDimension(R.styleable.CricleFrameLayout_radius, 0);
            topLeftRadius = ta.getDimension(R.styleable.CricleFrameLayout_topLeftRadius, radius);
            topRightRadius = ta.getDimension(R.styleable.CricleFrameLayout_topRightRadius, radius);
            bottomLeftRadius = ta.getDimension(R.styleable.CricleFrameLayout_bottomLeftRadius, radius);
            bottomRightRadius = ta.getDimension(R.styleable.CricleFrameLayout_bottomRightRadius, radius);
            ta.recycle();
        }
