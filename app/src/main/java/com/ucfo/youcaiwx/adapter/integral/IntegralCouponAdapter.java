...
/**
 * Author: AND
 * Time: 2019-10-15.  下午 4:58
 * Package: com.ucfo.youcaiwx.adapter.integral
 * FileName: IntegralCouponAdapter
 * Description:TODO 商品列表(优惠券)
 */
public class IntegralCouponAdapter extends BaseAdapter<IntegralProductListBean.DataBean, IntegralCouponAdapter.ViewHolder> {
    private Context context;
    private List<IntegralProductListBean.DataBean> list;

    public IntegralCouponAdapter(Context context, List<IntegralProductListBean.DataBean> list) {
    ...
    protected void onBindDataViewHolder(ViewHolder holder, int position) {
        IntegralProductListBean.DataBean couponBean = list.get(position);
