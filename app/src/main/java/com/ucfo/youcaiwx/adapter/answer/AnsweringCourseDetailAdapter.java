...
/**
 * Author: AND
 * Time: 2019-11-12.  下午 2:21
 * Package: com.ucfo.youcaiwx.adapter.answer
 * FileName: AnsweringCourseDetailAdapter
 * Description:TODO 课程答疑追问适配器
 */
public class AnsweringCourseDetailAdapter extends BaseAdapter<AnsweringCourseDetailsBean.DataBean.ReplyBean, AnsweringCourseDetailAdapter.ViewHolder> {
    ...
    public AnsweringCourseDetailAdapter(List<AnsweringCourseDetailsBean.DataBean.ReplyBean> list, Context context) {
        this.list = list;
    ...
    protected void onBindDataViewHolder(ViewHolder holder, int position) {
        ...
        if (position == 0) {
            ...
            if (!TextUtils.isEmpty(sectionName)) {
                ...
                TagAdapter<String> tagAdapter = new TagAdapter<String>(stringArrayList) {
                    @Override
