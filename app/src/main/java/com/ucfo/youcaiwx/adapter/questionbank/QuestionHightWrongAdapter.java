...
public class QuestionHightWrongAdapter extends BaseExpandableListAdapter {
    ...
    public QuestionHightWrongAdapter(ArrayList<QuestionBankHightErrorBean.DataBean> list, Context context, int plate_id) {
        this.list = list;
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (plate == Constant.PLATE_4) {//系统高频错题
