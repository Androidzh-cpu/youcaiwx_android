...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        Context instance = UcfoApplication.getInstance();
        instance.startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager manager =
                (ConnectivityManager) UcfoApplication.getInstance().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) UcfoApplication.getInstance().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) UcfoApplication.getInstance().getSystemService(Context.WIFI_SERVICE);
